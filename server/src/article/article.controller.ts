...
import { CommentsArticleService } from '../comments-article/comments-article.service';
...
export class ArticleController {
  ...
  async createArticle(@Body() createArticleDto: CreateArticleDto): Promise<Article | boolean> {
    const tt: Article | boolean = await this.articleService.createArticle(createArticleDto);
    console.log('########');
    return tt;
  }
